...
replace code.cloudfoundry.org/quarks-job => ../quarks-job

replace code.cloudfoundry.org/quarks-secret => ../quarks-secret

replace code.cloudfoundry.org/quarks-statefulset => ../quarks-statefulset
